...
import GuestsModal from '../../ModalWindows/GuestsModal/index.js';
...
const DestinationInput = () => {
  ...
  function addSelect() {
    const divWithText = document.querySelector('.popup-text-block');
  ...
  const minusCountChildren = () => {
    if (countChildren > 0) {
      setCountChildren(countChildren - 1);
      const deleteSelect = document.querySelectorAll('.div-for-select');
      const deleteText = document.getElementById('text-block');
      const lengthOfSelectedDivs = deleteSelect.length;
  ...
  return (
    <>
      ...
      <GuestsModal active={modalActive} setActive={setModalActive}>
        <div id="popup" className="popup">
          ...
          <div className="popup-counter counter-children">
            ...
            <span className="popup-content-buttons">
              <button
                type="button"
                className="children-btn children-min"
                data-direction="minus"
                onClick={minusCountChildren}
              >
                -
              </button>
              <input
              ...
              <button
                type="button"
                className="children-btn children-plus"
                data-direction="plus"
                onClick={plusCountChildren}
              >+
              </button>
            </span>
          </div>
          <div className="popup-counter">
            ...
            <span className="popup-content-buttons">
              <button
                type="button"
                className="counter-btn-rooms"
                data-direction="minus"
                onClick={minusCountRooms}
              >-
              </button>
              <input
                type="text"
                ...
                value={countRooms}
                className="counter-value-rooms"
              />
              <button
                type="button"
                className="counter-btn-rooms"
                data-direction="plusRoom"
                onClick={plusCountRooms}
              >+
              </button>
            </span>
          </div>
